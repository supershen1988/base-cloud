...
public class QRcodeUtil {
	...
	public static String createQrCode(String filePath, String content, int qrCodeSize, String imageFormat,
			String returnPath) throws WriterException, IOException {
		// String filePath = "";
		...
		String fileName = getFileName(imageFormat);
	 ...
	 * @param 文件类别
	 */
	public static String getFileName(String imageFormat) {
		return Ids.uuid2() + "." + imageFormat;
	}
